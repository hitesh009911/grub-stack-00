...
import './BigTruckLoader.css';

const BigTruckLoader: React.FC = () => {
  return (
    <div className="big-truck-loader">
      <div className="big-truck-wrapper">
        <div className="big-truck-body">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="big-truck-svg">
        ...
        <div className="big-truck-tires">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="big-tire-svg">
        ...
        <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#000000" className="big-lamp-post">
      ...
      <div className="loading-text">
        <h3 className="text-xl font-semibold text-gray-700 mb-2">Loading Restaurants...</h3>
        <p className="text-gray-500">Finding the best food near you</p>
      </div>
    </div>
  );
};

export default BigTruckLoader;
